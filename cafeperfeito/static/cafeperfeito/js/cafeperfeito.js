...
$.CafePerfeito.leftSideBar = {
    ...
    setMenuHeight: function (isFirstTime) {
        if (typeof $.fn.slimScroll != 'undefined') {
            var configs = $.CafePerfeito.options.leftSideBar;
            ...
            if ($.CafePerfeito.options.leftSideBar.scrollActiveItemWhenPageLoad) {
    ...
    checkStatusForResize: function (firstTime) {
        ...
        if (width < $.CafePerfeito.options.leftSideBar.breakpointWidth) {
...
$.CafePerfeito.dropdownMenu = {
    ...
    dropdownEffect: function (target) {
        var effectIn = $.CafePerfeito.options.dropdownMenu.effectIn,
            effectOut = $.CafePerfeito.options.dropdownMenu.effectOut;
